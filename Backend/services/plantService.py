...
async def create_employee_service(company_id: str, plant_id: str, financial_year: str, employee: Employee):
    """
    ...
    existing_employee = next((e for e in plant.get("employees", []) if e["employee_id"] == employee.employee_id), None)
